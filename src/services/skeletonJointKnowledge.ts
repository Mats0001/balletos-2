...
export const JOINT_KNOWLEDGE: Record<number, JointKnowledge> = {
  ...
  25: {
    ...
    anatomyNote: 'Landmark 25 markiert das linke Knie. Aus einem einzelnen 2D-Frame bestimmt BalletOS derzeit weder eine belastbare Abweichungsrichtung noch einen Valgusgrad.',
    vaganovaRule: 'Nicole betrachtet die sichtbare Linie von Hüfte, Knie und Fuß im Kontext der konkreten Position und Bewegungsphase.',
    howAndWhy: '"Schau auf die Knie-Fuß-Linie wie auf eine Spur im Spiegel." Dieses Bild unterstützt Nicoles Unterricht; es ist keine automatisch aus dem Frame abgeleitete Ursache.',
    exerciseTitle: 'Spiegel-Beobachtung nach Nicoles Freigabe',
    exercise: 'Nicole kann einen passenden Referenzframe festlegen und die sichtbare Knie-Fuß-Linie gemeinsam mit der Schülerin vergleichen. BalletOS leitet daraus keine automatische Kraft- oder Diagnoseaussage ab.',
    commonMistake: 'Noch kein automatischer Befund: Nicole prüft Knie-Fuß-Linie, Perspektive und Bewegungsphase.',
  },
  26: {
    name: 'Rechtes Knie', nameShort: 'R-Knie', emoji: '🦵', region: 'leg',
    anatomyNote: 'Landmark 26 markiert das rechte Knie. Aus einem einzelnen 2D-Frame bestimmt BalletOS derzeit weder eine belastbare Abweichungsrichtung noch einen Valgusgrad.',
    vaganovaRule: 'Nicole betrachtet die sichtbare Linie von Hüfte, Knie und Fuß im Kontext der konkreten Position und Bewegungsphase.',
    howAndWhy: '"Schau auf die Knie-Fuß-Linie wie auf eine Spur im Spiegel." Dieses Bild unterstützt Nicoles Unterricht; es ist keine automatisch aus dem Frame abgeleitete Ursache.',
    exerciseTitle: 'Spiegel-Beobachtung nach Nicoles Freigabe',
    exercise: 'Nicole kann einen passenden Referenzframe festlegen und die sichtbare Knie-Fuß-Linie gemeinsam mit der Schülerin vergleichen. BalletOS leitet daraus keine automatische Kraft- oder Diagnoseaussage ab.',
  ...
  27: {
    ...
    anatomyNote: 'Landmark 27 markiert den linken Knöchel als sichtbaren Punkt der Knie-Fuß-Linie. Ein einzelner 2D-Frame belegt weder Einrollrichtung noch Ursache.',
    vaganovaRule: 'Nicole beurteilt die Ausrichtung des Knöchels im Kontext von Position, Belastung, Perspektive und Bewegungsphase.',
    howAndWhy: '"Der Knöchel ist das Fundament des Turms." Das ist ein allgemeines Unterrichtsbild und keine automatisch aus diesem Frame abgeleitete Ursache.',
    exerciseTitle: 'Nächster Schritt nach Nicoles Beurteilung',
    exercise: 'Nicole entscheidet anhand der sichtbaren Bewegung, ob eine Beobachtung oder Übung sinnvoll ist. BalletOS leitet aus diesem Einzelbild keine Kräftigungs- oder Diagnoseempfehlung ab.',
    commonMistake: 'Noch kein automatischer Befund: Nicole prüft Knöchel, Knie-Fuß-Linie und Bewegungsphase.',
  },
  28: {
    name: 'Rechter Knöchel', nameShort: 'R-Knöchel', emoji: '🦶', region: 'foot',
    anatomyNote: 'Landmark 28 markiert den rechten Knöchel als sichtbaren Punkt der Knie-Fuß-Linie. Ein einzelner 2D-Frame belegt weder Einrollrichtung noch Ursache.',
    vaganovaRule: 'Nicole beurteilt die Ausrichtung des Knöchels im Kontext von Position, Belastung, Perspektive und Bewegungsphase.',
    howAndWhy: '"Der Knöchel ist der Anker der Bewegung." Das ist ein allgemeines Unterrichtsbild und keine automatisch aus diesem Frame abgeleitete Ursache.',
    exerciseTitle: 'Nächster Schritt nach Nicoles Beurteilung',
    exercise: 'Nicole entscheidet anhand der sichtbaren Bewegung, ob eine Beobachtung oder Übung sinnvoll ist. BalletOS leitet aus diesem Einzelbild keine Kräftigungs- oder Diagnoseempfehlung ab.',
    commonMistake: 'Noch kein automatischer Befund: Nicole prüft Knöchel, Knie-Fuß-Linie und Bewegungsphase.',
  },
