              ...
              return (
                ...
                >
                  ...
                  <div style={{
                    ...
                    color: cue.status === 'CORRECTION' ? '#fe7878' : cueColor(cue.status),
                    background: cue.status === 'CORRECTION' ? 'rgba(254,120,120,0.1)' : cue.status === 'WARNING' ? 'rgba(255,159,10,0.1)' : 'rgba(48,209,88,0.1)',
